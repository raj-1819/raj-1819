...
<div align="center">
  ...
  <a href="mailto:jangamr836@gmail.com">
...
<div align="center">
  <a href="https://github.com/raj-1819/Home-SOC-Lab-Splunk-SIEM">
    <img src="https://github-readme-stats.vercel.app/api/pin/?username=raj-1819&repo=Home-SOC-Lab-Splunk-SIEM&theme=dark" alt="SOC Lab" />
  </a>
  <a href="https://github.com/raj-1819/email-phishing-detection">
    <img src="https://github-readme-stats.vercel.app/api/pin/?username=raj-1819&repo=email-phishing-detection&theme=dark" alt="phishing project" />
  </a>
</div>
...
<table>
  <tr>
    ...
    <td>3-VM isolated lab ingesting 6,200+ live events; 4 custom SPL detection rules mapped to MITRE ATT&CK T1110, T1059, T1046</td>
  </tr>
  <tr>
    <td>🤖</td>
    <td><strong>ML-Driven Email Phishing Detection</strong></td>
    <td>Real-time pipeline using Random Forest + TF-IDF trained on 10,000 emails; IMAP monitoring with OCR and URL risk scoring</td>
  </tr>
  <tr>
    <td>🏥</td>
    <td><strong>Risk Assessment in Healthcare Organization</strong></td>
    <td>Mapped 15+ vulnerabilities to NIST CSF; applied FMEA reducing detection time by 35% via automated monitoring protocol</td>
  </tr>
  <tr>
    <td>🔐</td>
    <td><strong>Secure Messaging & HIPAA Privacy Audit</strong></td>
    <td>Audited 3 HIPAA apps uncovering 10 vulnerabilities; engineered AES-256 + TLS 1.3 architecture cutting attack surface by 20%</td>
  </tr>
  <tr>
    <td>💉</td>
  ...
  <tr>
    ...
    <td>Hands-on CyberArk Privileged Access Management lab covering credential vaulting, session monitoring, and least-privilege policies</td>
  </tr>
  <tr>
    <td>☁️</td>
